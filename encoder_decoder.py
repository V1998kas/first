...
lblInfo = Label(Tops, font = ('helvetica', 50, 'bold'), text = "SECRET MESSAGING \n Vikas's encoder - decoder ", fg = "Black", bd = 10, anchor = 'w')

lblInfo.grid(row = 0, column = 0)

lblInfo = Label(Tops, font = ('aerial', 20, 'bold'), text = localtime, fg = "Steel Blue", bd = 10, anchor = 'w')
...
txtReference = Entry(f1, font = ('arial', 16, 'bold'), textvariable = rand, bd = 10, insertwidth = 4,bg
 = "powder blue", justify= 'right')
